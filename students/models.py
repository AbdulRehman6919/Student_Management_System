...
class Donor(models.Model):
    ...
    NID = models.CharField(max_length=80,null=True,blank=True)
...
class DonorAmount(models.Model):
...
class Earning(models.Model):
    ...
    STATUS_CHOICES = (
    ('zakat','zakat'.upper()),
    ('donation', 'donation'.upper()),
    ('instituitions','instituitions'.upper()),
    ('miscellaneous','miscellaneous'.upper())
    )

    earning_id = models.PositiveIntegerField()
    description = models.CharField(max_length=200)
    type = models.CharField(max_length=20,choices=STATUS_CHOICES,default='donation')
