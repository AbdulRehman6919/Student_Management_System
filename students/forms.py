...
from .models import Earning, Student,StudentFees,Teacher,TeacherSalary,Donor,DonorAmount
...
class DonorForm(forms.ModelForm):
    class Meta:
        model = Donor
        fields = ['donor_id','NID','donor_name','phone_num','image']
        ...
        widgets = {
            'donor_id': forms.NumberInput(attrs={'class':'form-control'}),
...
class DonorAmountForm(forms.ModelForm):
    class Meta:
        model = DonorAmount
        fields = ['donor_id','date','amount','date_time_logged']
        # fields = '__all__'  you can also add that line to include all fields in that form 
...
class EarningForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['earning_id','description','type','amount','comment']

        widgets = {
            'earning_id': forms.NumberInput(attrs={'class':'form-control'}),
            'amount' : forms.NumberInput(attrs={'class':'form-control'}),
